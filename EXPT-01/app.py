...
def generate_metrics_graph(x, y, m, c, mae, mse, rmse, r_squared):
    ...
    ax1.scatter(x_arr, y_arr, color='#ff69b4', edgecolor='#047857', s=55, alpha=0.75, label='Actual Data Points')
    ...
    ax1.plot(x_line, y_line, color='#ff9500', linestyle='-', linewidth=2.2, label=line_label)
